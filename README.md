...
This will download a specific list of artefacts generated by the build into the current directory.
Also the name of artifact has to be matched to the name defined in source plan.
